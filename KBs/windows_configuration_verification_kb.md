...
21. Post-Check Evaluation
22. Evidence Collection Template
23. Quick Copy Bundle
...
- PASS: valore allineato al risultato atteso
- WARNING: valore coerente ma con stato transitorio (es. reboot pending)
- FAIL: valore non allineato o chiave mancante

Azioni consigliate:
1. correggere i FAIL con script di hardening
2. rieseguire i soli controlli impattati
3. archiviare output in evidenza di compliance
...
- Note e remediation ID

---

## 23) Quick Copy Bundle (all checks)
